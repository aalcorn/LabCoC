...
public class MyApplication extends Application {
    ...
    public JSONArray facilitiesArray = new JSONArray();
    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String MAINTEXT = "text";
    public static final String DOWNTEXT = "downtext";
    public static final String FACTEXT = "factext";

    //FACILITY ARRAY METHODS

    public void saveFacs() {
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS,MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();

        editor.putString(FACTEXT, facilitiesArray.toString());
        editor.apply();
    }

    public void loadFacs() {
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS,MODE_PRIVATE);
        try {
            facilitiesArray = new JSONArray(sharedPreferences.getString(FACTEXT,""));
    ...
    public void clearFacs() {
        facilitiesArray = new JSONArray();
        saveFacs();
    }

    public String toFacString() {
        return facilitiesArray.toString();
    }
